...
std::string leduc1raise_equilibrium_p1 = "/Users/ckroer/Documents/research/zerosum/equilibrium_strategies/leduc1raisex.txt";
std::string leduc1raise_equilibrium_p2 = "/Users/ckroer/Documents/research/zerosum/equilibrium_strategies/leduc1raisey.txt";


double leduckj1_game_value = 0;
std::string leduckj1_path = original_game_files + "leduckj1.txt";
std::string leduckj1_equilibrium_p1 = "/Users/ckroer/Documents/research/zerosum/equilibrium_strategies/leduckj1x.txt";
std::string leduckj1_equilibrium_p2 = "/Users/ckroer/Documents/research/zerosum/equilibrium_strategies/leduckj1y.txt";


double leduck2_game_value = 0;
std::string leduck2_path = original_game_files + "leduck2.txt";
std::string leduck2_equilibrium_p1 = "/Users/ckroer/Documents/research/zerosum/equilibrium_strategies/leduck2x.txt";
std::string leduck2_equilibrium_p2 = "/Users/ckroer/Documents/research/zerosum/equilibrium_strategies/leduck2y.txt";


double leduckj2_game_value = 0;
std::string leduckj2_path = original_game_files + "leduckj2.txt";
std::string leduckj2_equilibrium_p1 = "/Users/ckroer/Documents/research/zerosum/equilibrium_strategies/leduckj2x.txt";
std::string leduckj2_equilibrium_p2 = "/Users/ckroer/Documents/research/zerosum/equilibrium_strategies/leduckj2y.txt";


double leduc_4betsizes_game_value = -0.0852061;
std::string leduc_4betsizes_path = original_game_files + "leduc_4betsizes.txt";
std::string leduc_4betsizes_equilibrium_p1 = "/Users/ckroer/Documents/research/zerosum/equilibrium_strategies/leduc_4betsizesx.txt";
std::string leduc_4betsizes_equilibrium_p2 = "/Users/ckroer/Documents/research/zerosum/equilibrium_strategies/leduc_4betsizesy.txt";
}
}